...
EXTERN_FUNCTION( long  last_process_id, (_VOID_) );
...
EXTERN_FUNCTION( CLASS get_process_class, (PROCESS_PTR) );
EXTERN_FUNCTION( CLASS get_this_process_class, (_VOID_) );
...
EXTERN_FUNCTION( void	server_stats_on, (FACILITY) );
EXTERN_FUNCTION( void	server_stats_off, (FACILITY) );
...
EXTERN_FUNCTION( double server_serv_time_remaining, (FACILITY, long) );
...
EXTERN_FUNCTION( void   collect_class_storage, (STORE) );
EXTERN_FUNCTION( void	collect_class_storage_all, (_VOID_) );
...
EXTERN_FUNCTION( TIME	storage_class_busy_amt, (STORE, CLASS) );
EXTERN_FUNCTION( TIME	storage_class_waiting_amt, (STORE, CLASS) );
EXTERN_FUNCTION( long	storage_class_request_cnt, (STORE, CLASS) );
EXTERN_FUNCTION( long	storage_class_release_cnt, (STORE, CLASS) );
EXTERN_FUNCTION( double	storage_class_request_total, (STORE, CLASS) );
EXTERN_FUNCTION( double	storage_class_release_total, (STORE, CLASS) );
EXTERN_FUNCTION( double	storage_class_request_amt, (STORE, CLASS) );
...
EXTERN_FUNCTION( void collect_class_buffer, (BUFFER b) );
EXTERN_FUNCTION( void collect_class_buffer_all, (_VOID_) );
EXTERN_FUNCTION( long buffer_class_get_total, (BUFFER b, CLASS c) );
EXTERN_FUNCTION( long buffer_class_put_total, (BUFFER b, CLASS c) );
EXTERN_FUNCTION( long buffer_class_get_count, (BUFFER b, CLASS c) );
EXTERN_FUNCTION( long buffer_class_put_count, (BUFFER b, CLASS c) );
EXTERN_FUNCTION( double buffer_class_get_timeQueue, (BUFFER b, CLASS c) );
EXTERN_FUNCTION( double buffer_class_put_timeQueue, (BUFFER b, CLASS c) );
...
EXTERN_FUNCTION( void compute_confidence_statistics, (TABLE, double, double*, double*, double*) );
